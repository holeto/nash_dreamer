...
plots exactly (per-game algo-dir overrides for leduc handled the same way):
    ...
    python -m experiments.plot_total_steps_grid
...
from experiments.plot_metrics import assign_colors, load_algo_metrics
from experiments.plot_total_steps_comparison import (
    classify_mode,
