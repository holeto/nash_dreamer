...
renderer unchanged; only the x-axis values fed into the shared renderer differ.
    ...
    python -m experiments.plot_total_steps_comparison \
...
from experiments.plot_metrics import load_algo_metrics, render_plot
...
def trajectory_length(game_name):
    ...
    if game_name == "phantom_ttt":
        from games.jax_phantom_ttt import JaxPhantomTTT
